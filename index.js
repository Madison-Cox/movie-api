...
let allowedOrigins = ['http://localhost:1234', 'http://localhost:4200', 'localhost:1234', 'https://movie-scout.herokuapp.com']
...
//READ FIND MOVIES BY DIRECTOR
app.get('/:Director/movies', passport.authenticate('jwt', { session: false }), (req, res) => {
